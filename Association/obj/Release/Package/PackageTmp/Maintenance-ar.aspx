            ...
            <div class="row main-row">
                <div class="col-md-5">
                    ...
                    <div class="input-group datetime">
                        <input id="Txtdatefrom"class="text-right" style="color:black" dir="ltr" placeholder="التاريخ من "CssClass="form-control" type="text" />
                ...
                <div class="col-md-5">
                    ...
                    <div class="input-group datetime">
                        <input id="TxtdateTo"class="text-right" style="color:black" dir="ltr" placeholder="التاريخ إلي "CssClass="form-control" type="text" />
                        <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                    </div>
                </div>
            </div>
